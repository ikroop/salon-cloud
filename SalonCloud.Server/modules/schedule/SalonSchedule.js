...
class SalonSchedule extends Schedule_1.Schedule {
    ...
    checkDailySchedule(dailySchedule) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var result = yield ScheduleModel_1.DailyScheduleModel.findOne({ salon_id: this.salonId, employee_id: null, "day.date": dailySchedule._id }).exec(function (err, docs) {
                if (err) {
    ...
    checkWeeklySchedule() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var result = yield ScheduleModel_1.WeeklyScheduleModel.findOne({ salon_id: this.salonId, employee_id: null }).exec(function (err, docs) {
                if (err) {
                    return returnResult.err = err;
                }
                else if (docs) {
    ...
    updateDailySchedule(dailySchedule) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var docsFound = yield ScheduleModel_1.DailyScheduleModel.findOne({ salon_id: this.salonId, employee_id: null }).exec();
    ...
    updateWeeklySchedule(weeklyScheduleList) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            var docsFound = yield ScheduleModel_1.WeeklyScheduleModel.findOne({ salon_id: this.salonId, employee_id: null }).exec();
